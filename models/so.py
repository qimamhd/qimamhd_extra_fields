...
#     def _get_extra_field_names(self):
#         return self.env['sale.extra.field.config'].search([]).mapped('field_name')

#     def _prepare_invoice(self):
#         vals = super()._prepare_invoice()

#         for f in self._get_extra_field_names():
